  ...
  return (
    ...
    >
      <Link
        ...
        className="group block h-full rounded-2xl border border-gray-200 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-brand-700 hover:shadow-xl"
      >
        <div className="flex items-start justify-between">
          <span className="readout text-xs text-brand-700">{company.code}</span>
          <ArrowUpRight
            size={18}
        ...
        <h3 className="mt-6 font-display text-xl font-bold text-brand-900">{company.name}</h3>
