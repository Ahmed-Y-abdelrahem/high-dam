...
const stats = [
  { icon: Shield, value: 0, suffix: "", label: "Lost Time Injuries" },
  { icon: TrendingDown, value: 95, suffix: "%", label: "Incident Reduction" },
  { icon: Users, value: 500, suffix: "+", label: "Trained Personnel" },
            ...
            >
              <div className="mb-4 flex justify-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-yellow-400/10 border border-yellow-400/20 transition-all duration-300 group-hover:bg-yellow-400 group-hover:scale-110">
                  <stat.icon size={32} className="text-yellow-400 transition-colors duration-300 group-hover:text-teal-900" />
                </div>
              </div>
