...
export default function IndustryCTA({ industryName }) {
  return (
        ...
        >
          <div className="text-center">
            ...
            <h2 className="font-display text-3xl font-bold text-teal-900 md:text-4xl">
              Ready to discuss your {industryName} needs?
            </h2>
            <p className="mx-auto mt-5 max-w-xl text-lg text-gray-600 leading-relaxed">
              Our team has the expertise to deliver tailored solutions for your industry. Let's build something exceptional together.
            </p>
