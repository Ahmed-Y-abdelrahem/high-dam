...
export default function IndustryProjects({ projects, industrySlug }) {
  return (
    <section className="relative overflow-hidden bg-teal-900 py-28">
      {/* Background Pattern */}
      ...
      <Container className="relative z-10">
        <SectionHeader
          ...
          title="Our work in this sector."
          description="Explore our portfolio of successfully delivered projects in this industry."
          dark
        />
          ...
          {projects.map((project, i) => (
            ...
            >
              ...
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-yellow-400/10 transition-all duration-300 group-hover:bg-yellow-400">
                <Building2 size={24} className="text-yellow-400 transition-colors duration-300 group-hover:text-teal-900" />
              </div>
        ...
        >
          <Link
            href="/projects"
            className="inline-flex items-center gap-2 rounded-full border border-yellow-400/50 bg-yellow-400/10 px-6 py-3 text-sm font-semibold text-yellow-400 transition-all duration-300 hover:bg-yellow-400 hover:text-teal-900"
          >
            View All Projects
            <ArrowRight size={16} />
          </Link>
