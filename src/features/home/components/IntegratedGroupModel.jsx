...
function CompanyCard({ company, index }) {
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-teal-800/50 to-teal-950/50 p-6 backdrop-blur-sm transition-all duration-300 hover:border-yellow-400/50"
    >
...
export default function IntegratedGroupModel() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-teal-900 to-teal-950 py-28 md:py-32">
      ...
      <Container className="relative z-10">
        <SectionHeader
          overline="Corporate Structure"
          title="One Holding Company. Five Specialized Entities."
          description="High Dam Group operates as an integrated holding company, orchestrating five specialized subsidiaries to deliver comprehensive project solutions under unified management and standards."
          dark
          align="center"
        />
        <div className="mx-auto mt-16 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <motion.div
              ...
              className="md:col-span-1 md:row-span-2 relative overflow-hidden rounded-2xl border-2 border-yellow-400/50 bg-gradient-to-br from-teal-700 to-teal-950 p-8 backdrop-blur-sm"
            >
              ...
              <div className="relative z-10 flex flex-col items-center justify-center h-full text-center">
                ...
                >
                  <Building2 size={32} className="text-teal-900" />
                </motion.div>
                ...
                <p className="text-sm text-white/70">GROUP</p>
                <div className="mt-6 pt-6 border-t border-white/20 w-full">
                  <p className="text-xs text-white/60 leading-relaxed">
                    One Group. One Standard. Total Project Control.
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        >
          <div className="mb-12 text-center">
            <p className="readout text-xs tracking-[3px] text-yellow-400 mb-3">STRATEGIC ADVANTAGES</p>
              ...
              >
                <div className="relative flex items-start gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-yellow-400/10 transition-all duration-300 group-hover:bg-yellow-400">
                    <item.icon size={22} className="text-yellow-400 transition-colors duration-300 group-hover:text-teal-900" />
                  </div>
                  <div>
